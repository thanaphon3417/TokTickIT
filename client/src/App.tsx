...
export default function App() {
  ...
  if (user.role !== "REQUESTER") return <AuthFrame><h1 className="h3">Welcome, {user.name}</h1><p>Your {user.role === "IT_STAFF" ? "IT Staff" : "Administrator"} workspace is being prepared.</p><button className="btn btn-outline-success" type="button" onClick={() => void endSession()}>Log out</button></AuthFrame>;
